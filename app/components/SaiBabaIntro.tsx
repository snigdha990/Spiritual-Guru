...
export default function SaiBabaIntro() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,200,120,0.12),transparent_70%)]" />

      {/* Static mandala for depth */}
      <img
        src="/mandalas/indian-mandala.svg"
        alt=""
        className="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2
                   w-[42rem] opacity-[0.05] pointer-events-none"
      />
      ...
      <motion.h2
        ...
        className="relative z-10 text-5xl sm:text-6xl md:text-7xl font-bold
                   text-center mb-20 bg-clip-text text-transparent
...
const GuruCard = ({
  ...
  return (
    ...
    >
      {/* Rounded Image */}
      {/* <div className="w-full sm:w-56 h-64 rounded-2xl overflow-hidden flex-shrink-0">
        <img
          src={imgSrc}
          alt={name}
      ...
      <div className="relative w-full sm:w-56 h-64 rounded-2xl overflow-hidden">
        <img
          src={imgSrc}
          alt={name}
          className="w-full h-full object-cover scale-118"
        />
        {/* soft overlay */}
