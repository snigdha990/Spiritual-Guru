...
//   return (
//     <footer className="relative py-16 bg-gradient-to-t from-[#1a1a2e] via-[#0a0a0f] to-[#0a0a0a] text-center text-gray-300 overflow-hidden rounded-t-3xl mx-6 sm:mx-12">
//       {/* Floating mystical blobs */}
//       <div
//         className={`absolute top-6 left-1/4 rounded-full animate-slowFloat blur-2xl pointer-events-none
//         ${isMobile ? 'w-28 h-28' : 'w-40 h-40'} bg-purple-600/20`}
...
//       {/* Footer heading */}
//       <motion.h3
//         className="relative z-10 text-2xl sm:text-3xl font-bold mb-6 text-yellow-300"
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 1 }}
//       >
...
//       {/* Footer text */}
//       <motion.p
//         className="relative z-10 text-sm sm:text-base mb-2"
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 1, delay: 0.3 }}
//       >
