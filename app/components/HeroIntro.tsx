...
export default function HeroIntro() {
  ...
  useEffect(() => {
    ...
    // Main particles (reduced)
    const generated: Particle[] = Array.from({ length: 12 }, () => ({
      top: Math.random() * 100,
    ...
    <section className="relative w-full h-screen flex flex-col justify-center items-center bg-gradient-to-b from-[#0a0a0a] to-[#1a1a2e] overflow-hidden px-6">
      ...
      <motion.h1
        className="relative z-10 text-5xl sm:text-6xl md:text-7xl font-bold
                   ...
                   from-yellow-300 via-pink-300 to-purple-300 text-center"
      ...
      <motion.p
        className="relative z-10 mt-6 text-center text-lg sm:text-xl md:text-2xl
                   text-gray-300 max-w-2xl"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.4, duration: 1 }}
      >
        Discover insights, connect with your inner self, and experience guidance
        from the AI Spiritual Guru.
      </motion.p>
