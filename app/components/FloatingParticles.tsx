    ...
    <>
      ...
      <style jsx>{`
        @keyframes float {
          ...
          25% {
            transform: translateY(-5px) translateX(calc(var(--x-offset)/4)) scale(1.05);
            opacity: calc(var(--opacity) + 0.05);
          }
          50% {
            transform: translateY(-10px) translateX(var(--x-offset)) scale(1);
            opacity: var(--opacity);
          }
          75% {
            transform: translateY(-5px) translateX(calc(var(--x-offset)/2)) scale(0.95);
            opacity: calc(var(--opacity) + 0.02);
          }
          100% {
            transform: translateY(0) translateX(0) scale(1);
            opacity: var(--opacity);
